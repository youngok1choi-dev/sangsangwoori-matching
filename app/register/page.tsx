...
import { recalculateMatchesForSenior } from '@/lib/matching';
...
type FormData = { name: string; region: string; desired_job: string; career_years: string };
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input id="name" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="홍길동" className="text-lg h-12" />
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Select value={form.region} onValueChange={(v) => setForm({ ...form, region: v })}>
                <SelectTrigger className="text-lg h-12"><SelectValue placeholder="지역을 선택해 주세요" /></SelectTrigger>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Select value={form.desired_job} onValueChange={(v) => setForm({ ...form, desired_job: v })}>
                <SelectTrigger className="text-lg h-12"><SelectValue placeholder="직종을 선택해 주세요" /></SelectTrigger>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input id="career_years" type="number" min={0} value={form.career_years} onChange={(e) => setForm({ ...form, career_years: e.target.value })} className="text-lg h-12" />
            </div>
